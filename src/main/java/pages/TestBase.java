...
public class TestBase {
	...
	public static void initDriver() {
		...
		System.setProperty("webdriver.chrome.driver", "driver1\\chromedriver3.exe");
	...
	public void takeScreenshot(WebDriver driver) throws IOException {
		TakesScreenshot ts = (TakesScreenshot)driver;//creating reference variable //driver we type casting
		File sourceFile  = ts.getScreenshotAs(OutputType.FILE);//its source file
		
		SimpleDateFormat formatter = new SimpleDateFormat("MMddyy_HHmss");//how do we want our date format 
		Date date = new Date();
